 ...
 */
public class EuropeanaFashionFormalizationLauncher {
	// trabajo de spring a ejecutar
	private static final String[] jobC = {
			"thesaurusFormalizer/formalizationJobs/EuropeanaFashionFormalizationJob.xml",
			"EuropeanaFashionFormalizationJob" };
