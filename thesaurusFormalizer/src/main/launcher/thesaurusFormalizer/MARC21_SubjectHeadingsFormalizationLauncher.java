 ...
 */
public class MARC21_SubjectHeadingsFormalizationLauncher {
	// trabajo de spring a ejecutar
	private static final String[] jobC = {
			"thesaurusFormalizer/formalizationJobs/MARC21_SubjectHeadingsFormalizationJob.xml",
			"MARC21_SubjectHeadingsFormalizationJob" };
